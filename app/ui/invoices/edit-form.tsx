...
export default function EditInvoiceForm({
  ...
  // This binds the invoice.id to your server action (CORRECT)
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <div className="flex gap-4">
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor="pending"
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-gray-100 
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor="paid"
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-green-500 
